...
var __LINEUP_SHEETS = {
  "1570342":{"BET":{start:["Álvaro Valles", "Angel Ortiz", "Diego Llorente", "Valentín Gómez", "Junior Firpo", "Facundo Bernal", "Nelson Deossa", "Antony", "Pablo Fornals", "Rodrigo Riquelme", "Cucho Hernández"],sub:["Álvaro de Pablo", "Manu González", "Natan", "Fran García", "Héctor Bellerín", "Marc Bartra", "Marc Roca", "Pablo García", "Iker Losada", "Isco", "Álvaro Fidalgo", "Troy Parrott"]},"VAL":{start:["Stole Dimitrievski", "Jesús Vázquez", "César Tárrega", "Pepelu", "Mouctar Diakhaby", "Pablo Maffeo", "Ryunosuke Sato", "Guido Rodríguez", "Javier Guerra", "Hugo Duro", "Arnaut Danjuma"],sub:["Kayne van Oevelen", "José Luis Gayà", "Iker Cordoba", "Alejandro Panach Olmo", "Filip Ugrinić", "Luis Rioja", "Jaume Durá", "Aliou Dieng", "André Almeida", "David Otorbi", "Dani Raba", "Umar Sadiq"]}},
};
